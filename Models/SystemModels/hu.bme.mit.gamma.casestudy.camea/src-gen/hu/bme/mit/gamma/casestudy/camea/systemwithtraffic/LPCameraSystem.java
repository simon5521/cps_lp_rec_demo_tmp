...
import hu.bme.mit.gamma.casestudy.camea.traffic.TrafficComp;
...
public class LPCameraSystem implements LPCameraSystemInterface {
	...
	private TrafficComp TrafficSimulator;
	// Port instances
	...
	public LPCameraSystem() {
		...
		lPNum = new LPNum();
		// Environmental Component instances
			TrafficSimulator = new TrafficComp();
		init();
	}
	...
	private void init() {
		...
		TrafficSimulator.getCars().registerListener(LPDetection.getInStream());
		LPDetection.getInStream().registerListener(TrafficSimulator.getCars());
	...
	public void notifyAllListeners() {
		...
		TrafficSimulator.notifyListeners();
		notifyListeners();
	}
	...
	// Environmental Component instances
		public TrafficComp getTrafficSimulator() {
